...
if ( ! class_exists( 'WP_REST_Menus' ) ) :
    ...
    class WP_REST_Menus {
        ...
        public function register_routes() {
            ...
            register_rest_route( self::get_plugin_namespace(), '/menus/(?P<slug>[a-zA-Z0-9_-]+)', array(
                array(
                    'methods'  => WP_REST_Server::READABLE,
        ...
        public static function get_menus() {
            ...
            foreach ( $wp_menus as $wp_menu ) :
                ...
                $rest_menus[ $i ]['meta']['links']['self']       = $rest_url . $menu['slug'];
        ...
        public function get_menu( $request ) {
            ...
            $wp_menu_object = $slug ? wp_get_nav_menu_object( $slug ) : array();
            $wp_menu_items  = $slug ? wp_get_nav_menu_items( $slug ) : array();
